...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'FINANCE', 'EDITOR');
...
-- CreateIndex
CREATE UNIQUE INDEX "Invoice_pengajuanId_key" ON "Invoice"("pengajuanId");
...
-- AddForeignKey
ALTER TABLE "Invoice" ADD CONSTRAINT "Invoice_pengajuanId_fkey" FOREIGN KEY ("pengajuanId") REFERENCES "Pengajuan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
